...
namespace Timelapse
{
    public class DBData
    {
        ...
        public DBData(string folderPath, string fileName)
        {
            this.CurrentId = -1;
            this.CurrentRow = -1;
        ...
        public bool TryCreateImageDatabase(Template template)
        {
            // Create the DB
            try
            {
        ...
        public void RenameDataFile(string newFileName, Template template)
        {
