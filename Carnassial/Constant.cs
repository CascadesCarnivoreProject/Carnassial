...
namespace Carnassial
{
    public static class Constant
    {
        ...
        public static class ResourceKey
        {
            ...
            public const string CarnassialWindowStatusImageSetLoadingFolders = "CarnassialWindow.Status.LoadingFolders";
            ...
            public const string DeleteFilesMessageFilesAndData = "DeleteFiles.Message.FilesData";
