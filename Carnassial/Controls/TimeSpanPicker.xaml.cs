...
namespace Carnassial.Controls
{
    ...
    public partial class TimeSpanPicker
    {
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(TimeSpan), typeof(TimeSpanPicker), new FrameworkPropertyMetadata(TimeSpan.Zero, TimeSpanPicker.SetValue, TimeSpanPicker.CoerceValue));
