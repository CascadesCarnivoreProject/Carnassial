...
namespace Carnassial.Data
{
    public class UpdateFileColumnTransactionSequence : WindowedTransactionSequence<FileLoad>
    {
            ...
            : base(database)
        {
            ...
            string fileUpdateText = String.Create(CultureInfo.InvariantCulture, $"UPDATE {Constant.DatabaseTable.Files} SET {SQLiteDatabase.QuoteIdentifier(dataLabel)}=@Value WHERE {Constant.DatabaseColumn.ID}=@{Constant.DatabaseColumn.ID}");
