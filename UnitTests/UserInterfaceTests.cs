        ...
        public void Carnassial()
        {
            ...
            lock (CarnassialTest.App)
            {
                ...
                using (CarnassialWindow carnassial = new())
                {
                    ...
                    UserInterfaceTests.ShowDialog(new ChooseFileDatabase(new List<string>() { TestConstant.File.DefaultNewFileDatabaseFileName }, TestConstant.File.DefaultTemplateDatabaseFileName, carnassial));
                    ...
                    UserInterfaceTests.ShowDialog(MessageBox.FromResource(Constant.ResourceKey.GithubReleaseClientGetNewVersion, App.Current.MainWindow, new Version(), Constant.ApplicationName, new Version(), CarnassialConfigurationSettings.GetReleasesBrowserAddress()));
                    UserInterfaceTests.ShowDialog(MessageBox.FromResource(Constant.ResourceKey.GithubReleaseClientNoUpdates, App.Current.MainWindow, Constant.ApplicationName, new Version()));
