...
namespace Timelapse
{
    ...
    {
        /// <summary>
        /// The marker's location in the canvas, as a coordinate point
        /// </summary>
        public Point Point { get; set; }

        /// <summary>
        /// The marker's outline color
        /// </summary>
        public Brush Brush { get; set; } // 

        /// <summary>
        /// Whether to visually emphasize the marker
        /// </summary>
        public bool Emphasise { get; set; } // 

        /// <summary>
        /// Whether to show the label next to the metatag
        /// </summary>
        public bool Annotate { get; set; } // 

        /// <summary>
        /// A flag to determine if the annotation has already been displayed (so we can turn it off)
        /// </summary>
        public bool AnnotationAlreadyShown { get; set; }
        /// <summary>
        /// The marker's tooltip text
        /// </summary>
        ...
        /// DataLabel
        /// </summary>
        public string DataLabel { get; set; }  // The data label associated with this metatag

        /// <summary>
        /// A GUID; its filled in on Metatag creation, but you can reset it
        /// </summary>
